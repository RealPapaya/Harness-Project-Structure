...
repo) go to `{{HOME}}\.agents\institution\lessons.md` instead, with one
pointer line here.

---

(no lessons yet — first session in this project should confirm the build/test
commands in AGENTS.md actually work, and record anything surprising here)
